...
def batch_norm(x, is_training, epsilon=1e-5, momentum=0.9, scope="batch_norm"):
    return tf.layers.batch_normalization(x, momentum=momentum, epsilon=epsilon, training=is_training, name=scope)
